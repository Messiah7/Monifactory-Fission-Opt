...
// Only fuels obtainable at the current progression stage are listed here.
// The Cm/B/Cf-series entries were removed together with their buttons in index.html.
// Values below are [power (RF/t), heat (H/t)] as confirmed against in-game tooltips.
const fuelPresets = {
    TBU:    [4800,   27],
    LEU235: [12960,  50],
    HEU235: [51840,  150],
    ...
    LEA242: [26880,  94],
    HEA242: [107520, 280],
    // Disabled: not obtainable at current progression stage.
    // Uncomment to re-enable (and uncomment the matching buttons in index.html).
    // LECm243: [16800, 112],
    // HECm243: [67200, 672],
    // LECm245: [12960, 68],
    // HECm245: [51840, 408],
